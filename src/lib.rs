...
pub use config::{
    build_output_path, format_result_summary, parse_size_to_bytes,
    prepare_compression_task, validate_dpi_range, validate_jpeg_quality, CompressionResult,
    CompressionTaskConfig, DEFAULT_MAX_DPI, DEFAULT_MIN_DPI, DEFAULT_MIN_QUALITY,
};
